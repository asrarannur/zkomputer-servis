      ...
      <main>
        <section className="hero-section" aria-labelledby="hero-title">
          ...
          <div className="hero-visual" aria-label="Meja kerja teknisi laptop">
            <div className="hero-image-frame"><picture><source media="(max-width: 700px)" srcSet="/assets/hero-workbench-960-v2.webp" type="image/webp" /><img src="/assets/hero-workbench-v2.webp" alt="Pemeriksaan laptop di meja kerja teknisi" width={1600} height={900} fetchPriority="high" decoding="async" /></picture></div>
            ...
            <div className="brand-stamp"><img src="/assets/zkomputer-logo-v2.webp" alt="" width={320} height={320} decoding="async" /><span>ZK//DIAGNOSTIC</span></div>
        ...
        <section className="process-section" id="proses" aria-labelledby="process-title">
          <div className="process-visual"><picture><source media="(max-width: 700px)" srcSet="/assets/service-detail-700-v2.webp" type="image/webp" /><img src="/assets/service-detail-v2.webp" alt="Detail pemeriksaan komponen laptop" width={1100} height={1375} loading="lazy" decoding="async" /></picture><div className="process-visual__label"><span />TELITI DALAM SETIAP LANGKAH</div></div>
